...
const zh = {
  ...
  account: {
    title: "账户设置",
    subtitle: "绑定两种登录方式，任一即可登录",
    hint: "绑定第二种登录方式后，即使邮箱失访或钱包丢失，您仍能登录并继续管理空间、余额与守望设置。",
    emailLabel: "邮箱",
    walletLabel: "钱包",
    notBound: "未绑定",
    bindEmail: "发送验证码并绑定",
  ...
  journal: {
    ...
    published: "已发布，永久保存",
    empty: "还没有时光记录",
    ownerHint: "每条记录都由空间钥匙签名，永久写入存储网络，无法删除或修改。",
    needContent: "写点什么，或者加一张照片",
    failed: "发布失败，请稍后再试",
    rejected: "内容未通过审核，请调整后再试",
    photoFailed: "照片上传失败",
    signInRequired: "请先登录后再发布",
  },
  watch: {
    title: "守望机制",
    subtitle: "为「人生进行时」的空间设置一份托付",
    intro:
      "如果你长期未登录，我们会先发邮件提醒你；仍无回应时，将请你信任的亲友协助确认。确认后还有 30 天冷静期——期间你登录一次，一切即会撤销。全部确认无误后，空间才会转为纪念模式，永久铭记。",
    enable: "开启守望",
    inactivityLabel: "多久未登录视为失联",
    daysUnit: "天",
    contactLabel: "守望联系人邮箱",
    contactPlaceholder: "trusted@example.com",
    save: "保存设置",
    saving: "保存中…",
    saved: "已保存",
    failed: "保存失败，请稍后再试",
    invalidEmail: "请填写有效的联系人邮箱",
    states: {
      none: "未开启",
      active: "守望中",
      overdue: "等待你确认平安",
      pending_confirm: "已请亲友确认",
      cooling: "冷静期",
      transitioned: "已转为纪念",
      disabled: "未开启",
    },
    coolingUntil: "冷静期至",
    empty: "此账户下还没有发布过的空间。发布后即可在这里设置守望。",
    spaceLink: "守望机制",
    aboutLink: "了解守望机制的完整约定",
    confirm: {
      title: "守望确认",
      body: "一位使用永铭 Evermark 的用户将您设为守望联系人。若 TA 确实已经离世，请点击下方按钮确认。确认后有 30 天冷静期——期间 TA 本人登录一次，一切即会撤销；冷静期结束后，TA 的空间将转为纪念模式。",
      warning: "请务必确认属实——这是一份不可轻率对待的托付。",
      button: "我确认 TA 已离世",
      confirming: "提交中…",
      done: "已收到确认。冷静期将于 30 天后结束，届时空间将转为纪念模式。感谢您的守望。",
      invalid: "此确认链接无效或已过期。若有疑问，请与发起守望的亲友联系。",
    },
    transitionNotice:
      "经守望机制确认，这个空间已从「人生进行时」转为纪念模式。",
  },
  billing: {
    balance: "余额",
    freeLeft: "免费额度剩余",
  ...
  space: {
    title: "我的空间",
    subtitle: "您在永铭建立与守护的空间。",
    keyLocalNote:
      "空间与您的账户绑定——换一台设备，登录即可继续管理。偏好完全自行保管的用户，可在高级选项中备份或导入密钥文件。",
    empty: "还没有属于您的空间。",
    importKey: "导入密钥备份",
    ...
    loadFailed: "无法加载空间内容，请稍后再试",
    keyMissing:
      "您的账户中没有此空间的管理权限。若您持有密钥备份文件，可导入后继续编辑。",
  },
  explore: {
    title: "缅怀长廊",
  ...
  create: {
    ...
    success: {
      title: "空间已建立",
      body: "内容已永久刻录，空间已绑定到您的账户。换一台设备，登录即可继续管理。",
      bodyFallback:
        "内容已永久刻录。请立即备份您的管理密钥——它是修改此空间的唯一凭证，一旦丢失无法找回。",
      keyTitle: "管理密钥备份",
      keyBody:
        "密钥仅保存在您当前浏览器中。请下载备份文件并妥善保存（例如保存到密码管理器）。",
      advanced: "高级：自行保管密钥",
      advancedBody:
        "您也可以下载密钥备份文件，实现完全自主保管——即使没有本站账户，持有此文件也能管理这个空间。",
      downloadKey: "下载密钥备份",
      copyLink: "复制空间链接",
      confirmSaved: "我已备份密钥",
      visit: "前往空间",
